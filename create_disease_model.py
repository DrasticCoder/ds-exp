...
def create_outbreak_risk_target(df):
    ...
    df["case_fatality_rate"] = df["Deaths_Reported"] / df["Cases_Reported"].replace(
        0, 1
    )
...
def prepare_features(df):
    ...
    df["healthcare_vaccination_score"] = (
        df["Healthcare_Expenditure_PctGDP"] * df["Vaccination_Coverage_Pct"]
    )
...
def main():
    ...
    expected_cols = {"expected_input_cols": all_input_cols}
